...
WITH oZip
	...
	*.ArchivosIncluir ='C:\PDA\DATOSCEL\IMP\*.xml'
	*.Contraseña='contraseña'	&& Proteger el zip con una contraseña, Opcional
...
WITH oZip
	...
	.Contraseña='contraseña'	&& Contraseña para desproteger el zip
