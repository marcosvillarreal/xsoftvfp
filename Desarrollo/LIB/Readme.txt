...
**************************
Revisions (04/02/99)
	- Because of the use of the new project object, SearchString now runs only under VFP 6.
	- Several bugs were fixed
	- Database search now allows searching specific database elements
	- double click to open a file now supports more file types
